...
export WORKER_LAZY_LOAD_MODEL="${WORKER_LAZY_LOAD_MODEL:-1}"
export WORKER_MODEL_IDLE_UNLOAD_SECONDS="${WORKER_MODEL_IDLE_UNLOAD_SECONDS:-300}"
export WORKER_STARTUP_WARMUP="${WORKER_STARTUP_WARMUP:-0}"
